...
<body <?php body_class(); ?>>
	...
	<div id="page-container" class="<?php echo $post_slug . '-page' ?>">
<?php
			...
			?>
				<div class="logo_container">
					...
					<!-- <a href="<?php echo esc_url( home_url( '/' ) ); ?>"> -->
						<a href="https://debat.nl/"> 
						<img src="<?php echo $template_directory_uri . '/../DiviChild/images/Debat-NL_Logo2.png' ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
				</div>
